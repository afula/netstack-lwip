...
pub const MEMP_NUM_TCP_PCB: u32 = 4096;
...
pub const TCP_MSS: u32 = 8191;
pub const TCP_WND: u32 = 65528;
pub const TCP_SND_BUF: u32 = 65528;
pub const TCP_SND_QUEUELEN: u32 = 1024;
pub const MEM_SIZE: u32 = 2097152;
pub const MEMP_NUM_TCP_SEG: u32 = 8192;
pub const PBUF_POOL_SIZE: u32 = 32;
...
pub const MEMP_NUM_PBUF: u32 = 8192;
pub const MEMP_NUM_RAW_PCB: u32 = 4;
pub const MEMP_NUM_UDP_PCB: u32 = 1024;
...
pub const MEMP_NUM_ALTCP_PCB: u32 = 4096;
...
pub const TCP_OVERSIZE: u32 = 8191;
...
pub const LWIP_VERSION_STRING_SUFFIX: &[u8; 2] = b"d\0";
...
unsafe extern "C" {
    pub fn hev_free(ptr: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
    pub fn hev_malloc(size: size_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    pub fn hev_calloc(nmemb: size_t, size: size_t) -> *mut ::std::os::raw::c_void;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct fd_set {
